<!DOCTYPE html>
<html lang="es" id="exe-page-moleoqtu-5jvyieu5h">
<head>
<meta charset="utf-8">
...
<title>6. Atribución y fichero descargable. | CONCRECCIÓN CURRICULAR de la SdA</title>
...
<div class="exe-content exe-export pre-js siteNav-hidden"><a href="#page-moleoqtu-5jvyieu5h" id="skipNav">Skip to content</a> <nav id="siteNav">
<ul>
...
</nav><main id="page-moleoqtu-5jvyieu5h" class="page"> 
<header class="main-header">
<div class="package-header"><p class="package-title">CONCRECCIÓN CURRICULAR de la SdA</p></div>
<div class="page-header"><h1 class="page-title">6. Atribución y fichero descargable.</h1></div>
</header><div id="page-content-page-moleoqtu-5jvyieu5h" class="page-content">
<article id="block-1777457734623-v5kgzxfmy" class="box">
...
<div id="idevice-1777457734621-cxj28zdjn" class="idevice_node download-source-file" data-idevice-path="../idevices/download-source-file/" data-idevice-type="download-source-file">
...
<tr>
<th>Título</th>
<td><span class="exe-prop-title">CONCRECCIÓN CURRICULAR de la SdA</span></td>
</tr>
<tr>
<th>Descripción</th>
...
<tr>
<th>Autoría</th>
<td><span class="exe-prop-author">Marcos Rodríguez González</span></td>
</tr>
<tr>
<th>Licencia</th>
...
<p style="text-align: center;">Este contenido fue creado con <a href="https://exelearning.net/">eXeLearning</a>, el editor libre y de fuente abierta diseñado para crear recursos educativos.</p></div><p class="exe-download-package-link"><a download="CONCRECCIÓN CURRICULAR de la SdA.elpx" href="#" onclick="if(typeof downloadElpx==='function')downloadElpx();return false;" style="background-color:#107275;color:#ffffff;">Descargar el archivo .elpx</a></p>
</div>
</div>
</article>
